ndwi <- function(band_folder, sensor_type="") {
  ...
  stacked <- stack(b_green, b_nir)
  message("stacked")
  ndwi_res <- spectralIndices(stacked, green = 1, nir = 2, indices = "NDWI")
  message("ndwi_res calculated")
